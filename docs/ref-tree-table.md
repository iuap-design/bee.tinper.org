...
import {RefTreeTable, RefTreeTableWithInput, createRefTreeTable} from 'ref-tree-table';
或
...
bottomButton |`bool`|true | 是否显示弹出层下边框工具栏， false不显示 true 显示`注意该属性为临时兼容配置后期可能随时会弃用` | 否
