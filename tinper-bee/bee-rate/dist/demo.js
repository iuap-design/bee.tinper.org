...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Rate = __webpack_require__(158);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _rcRate = __webpack_require__(159);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Rate = _interopRequireDefault(__webpack_require__(160));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _KeyCode = _interopRequireDefault(__webpack_require__(161));
	
	var _util = __webpack_require__(162);
	
	var _Star = _interopRequireDefault(__webpack_require__(163));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Demo2 = function (_Component) {
	    ...
	    Demo2.prototype.render = function render() {
	        return _react2['default'].createElement(_src2['default'], { allowHalf: true, value: this.state.value, onChange: this.handChange });
	    };
	...
	var Demo3 = function (_Component) {
	    ...
	    Demo3.prototype.render = function render() {
	        return _react2['default'].createElement(
	            'div',
	            null,
	            _react2['default'].createElement(_src2['default'], { value: this.state.value, onChange: this.handleChange, count: 8 }),
	            _react2['default'].createElement(
	                'span',
	                null,
	                this.state.value
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Demo4 = function (_Component) {
	    ...
	    function Demo4(props) {
	        ...
	        _this.handChange = function (value, type) {
	            switch (type) {
	                case 1:
	                    _this.setState({
	                        v1: value
	    ...
	    Demo4.prototype.render = function render() {
	        ...
	        return _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	                'li',
	                null,
	                _react2['default'].createElement(_src2['default'], { character: 'A', value: this.state.v1, onChange: function onChange(v) {
	                        _this2.handChange(v, 1);
	                    } })
	            ),
	            _react2['default'].createElement(
	                'li',
	                null,
	                _react2['default'].createElement(_src2['default'], { character: '\u5B57', value: this.state.v2, onChange: function onChange(v) {
	                        _this2.handChange(v, 2);
	                    } })
	            ),
	            _react2['default'].createElement(
	                'li',
	                null,
	                _react2['default'].createElement(_src2['default'], { character: _react2['default'].createElement(_beeIcon2['default'], { type: 'uf-bell' }), value: this.state.v3, onChange: function onChange(v) {
	                        _this2.handChange(v, 3);
	                    } })
	            ),
	            _react2['default'].createElement(
	                'li',
	                null,
	                _react2['default'].createElement(_src2['default'], { character: _react2['default'].createElement(_beeIcon2['default'], { type: 'uf-heart' }), value: this.state.v4, onChange: function onChange(v) {
	                        _this2.handChange(v, 4);
	                    } })
	            )
	        );
	    };
