...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Demo6 = function (_Component) {
	    ...
	    function Demo6() {
	        ...
	        return _ret = (_temp = (_this = _possibleConstructorReturn(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this.add = function () {
	            console.log("在这里添加操作 ^_^");
	        }, _temp), _possibleConstructorReturn(_this, _ret);
	    }
	        ...
	        return _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	                _src2['default'],
	                {
	                    ...
	                    extraContent: _react2['default'].createElement(
	                        _beeButton2['default'],
	                        { className: 'add-button', colors: 'primary', onClick: this.add },
	                        '\u4E00\u4E9B\u64CD\u4F5C'
	                    )
	                },
	                _react2['default'].createElement(
