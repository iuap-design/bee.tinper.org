...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Demo1 = __webpack_require__(160);var Demo2 = __webpack_require__(161);var Demo3 = __webpack_require__(162);var DemoArray = [{ "example": _react2['default'].createElement(Demo1, null), "title": " 基础用法 ", "code": "/**\n * @title 基础用法 \n * @description Breadcrumb.Item定义子面包，`active`参数定义当前状态。\n */\n\nimport React, { Component } from 'react';\nimport { Breadcrumb } from 'tinper-bee';\n\n\nclass Demo1 extends Component {\n\trender () {\n\t\treturn (\n\t\t\t<Breadcrumb>\n\t\t\t    <Breadcrumb.Item href=\"#\">\n\t\t\t      Home\n\t\t\t    </Breadcrumb.Item>\n\t\t\t    <Breadcrumb.Item>\n\t\t\t      Library\n\t\t\t    </Breadcrumb.Item>\n\t\t\t    <Breadcrumb.Item active>\n\t\t\t      Data\n\t\t\t    </Breadcrumb.Item>\n\t\t\t</Breadcrumb>\n\t\t)\n\t}\n}\n\nexport default Demo1;", "desc": " Breadcrumb.Item定义子面包，`active`参数定义当前状态。" }, { "example": _react2['default'].createElement(Demo2, null), "title": " 图标 ", "code": "/**\n * @title 图标 \n * @description 使用Icon图标组件。\n */\n\nimport React, { Component } from 'react';\nimport { Icon, Breadcrumb } from 'tinper-bee';\n\n\nclass Demo2 extends Component {\n\trender () {\n\t\treturn (\n\t\t\t<Breadcrumb>\n\t\t\t    <Breadcrumb.Item href=\"#\">\n                    <Icon type=\"uf-home\"></Icon>\n\t\t\t    </Breadcrumb.Item>\n\t\t\t    <Breadcrumb.Item href=\"#\">\n                    <Icon type=\"uf-caven\"></Icon>\n\t\t\t    </Breadcrumb.Item>\n\t\t\t    <Breadcrumb.Item active>\n\t\t\t\t\t<Icon type=\"uf-cart-o\"></Icon>\n\t\t\t    </Breadcrumb.Item>\n\t\t\t</Breadcrumb>\n\t\t)\n\t}\n}\n\nexport default Demo2;", "desc": " 使用Icon图标组件。" }, { "example": _react2['default'].createElement(Demo3, null), "title": " 图标加文字 ", "code": "/**\n * @title 图标加文字 \n * @description 图标放在文字前面。\n */\n\nimport React, { Component } from 'react';\nimport { Icon, Breadcrumb } from 'tinper-bee';\n\n\nclass Demo2 extends Component {\n\trender () {\n\t\treturn (\n\t\t\t<Breadcrumb>\n\t\t\t    <Breadcrumb.Item href=\"#\">\n                    <Icon type=\"uf-home\"></Icon>\n                    <span>Home</span>\n\t\t\t    </Breadcrumb.Item>\n\t\t\t    <Breadcrumb.Item href=\"#\">\n                    <Icon type=\"uf-caven\"></Icon>\n                    <span>Library</span>\n\t\t\t    </Breadcrumb.Item>\n\t\t\t    <Breadcrumb.Item active>\n                    <Icon type=\"uf-cart-o\"></Icon>\n\t\t\t        <span>Cart</span>\n\t\t\t    </Breadcrumb.Item>\n\t\t\t</Breadcrumb>\n\t\t)\n\t}\n}\n\nexport default Demo2;", "desc": " 图标放在文字前面。" }];
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _BreadcrumbItem = __webpack_require__(159);
